        ...
        <div _ngcontent-c11="" class="col-md-12">
            <ul _ngcontent-c11="" class="list-event">
                ...
                <li _ngcontent-c11="">
                    ...
                    <p _ngcontent-c11="" class="mr-top-10 title-two-line"><?=$infoLive->name?></p><a _ngcontent-c11="" class="btn btn-outline-secondary btn-sm">View Detail</a>
                    <!---->
                    <!---->
                    <!----><a _ngcontent-c11="" class="btn btn-info btn-sm"><i _ngcontent-c11="" class="icon icon-livestream" sid="<?=$infoLive->id?>"></i>Start Live</a></li>
            </ul>
        </div>
